 ...
 * @author nopal
 */ 
public class regProduk extends javax.swing.JFrame {
...
//public home datab=null;
    ...
    public void getDataid(String id){
        ...
        jLabel16.setText("          Ubah Data Produk");        
        txt_kode.setText(home.idProduk);
        String a = txt_kode.getText();
        txt_kode.setEnabled(false);
        
        
        try{            
            String sql="Select id_produk,nama_produk,jenis_produk,harga_produk,stok from produk "
                    + "where id_produk ='"+a+"'";
            ...
            while (rs.next()){
             ...
             txt_jenis.setText(rs.getString(3));
            ...
            JOptionPane.showMessageDialog(null,"data Produk gagal dipanggil : "+ e);
            }
    }
    ...
    private void initComponents() {
        ...
        jLabel16.setText("TAMBAH PRODUK & MERCHANDISE");
        ...
        jPanel14Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel14Layout.createSequentialGroup()
                ...
                .addComponent(txt_stock, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txt_jenis, javax.swing.GroupLayout.PREFERRED_SIZE, 245, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(22, 22, 22))
        );
    ...
    private void b_simpanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_b_simpanMouseClicked
        ...
        String asql="insert into produk values (?,?,?,?,?)";
        ...
        try{
                    ...
                    astat.setString(3,txt_jenis.getText());
                    astat.setString(4,txt_harga.getText());
                    astat.setString(5,txt_stock.getText());                   
                    astat.executeUpdate();

                    
                    JOptionPane.showMessageDialog(null,"Data Produk & Merchandise Berhasil Disimpan");
                    kosong();
                    txt_kode.requestFocus();                   
        }
    ...
    private void b_editMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_b_editMouseClicked
        ...
        String asql="update produk set nama_produk=?, jenis_produk=?, harga_produk=?, stok=? "
                + "where id_produk='"+b+"'";       
       // String atasan = c.replaceAll("\\s.*", "");
        try{
            PreparedStatement astat=conn.prepareStatement(asql); 
                    astat.setString(1,txt_nama.getText());
                    astat.setString(2,txt_jenis.getText());                
                    astat.setString(3,txt_harga.getText());
                    astat.setString(4,txt_stock.getText());     
            astat.executeUpdate();
            
            JOptionPane.showMessageDialog(null,"Data Produk/ Merchandise Berhasil diubah");
            kosong();
