 ...
 * @author nopal
 */ 
public class regTrainer extends javax.swing.JFrame {
...
//public home datab=null;
    ...
    public void getDataid(String id){
        ...
        jLabel16.setText("            Ubah Identitas Trainer");        
        txt_kode.setText(home.idTrainer);
        String a = txt_kode.getText();
        txt_kode.setEnabled(false);
        String gender="",aktif="";
        
        try{            
            String sql="Select id_instruktur,nama_instruktur,usia,gender,alamat,no_telp,email,tanggal_join,aktif from instruktur_gym "
                    + "where id_instruktur='"+a+"'";
            ...
            while (rs.next()){
             ...
             dateJoin.setDate(rs.getDate(8));
             aktif=(rs.getString(9));
             if (aktif.equals("aktif")){cAktif.setSelected(true);}
             else if (aktif.equals("Nonaktif")){cAktif.setSelected(false);}
             }
        }
    ...
    public void autoID(){
        ...
        String var1 = "TRA-";
        String var2 = null;
        String sql="select id_instruktur from instruktur_gym order by id_instruktur desc limit 1";
         try{
    ...
    private void initComponents() {
        ...
        cAktif = new javax.swing.JCheckBox();
        ...
        jLabel16.setText("TAMBAH TRAINER GYM");

        javax.swing.GroupLayout jPanel2Layout = new javax.swing.GroupLayout(jPanel2);
        jPanel2.setLayout(jPanel2Layout);
        jPanel2Layout.setHorizontalGroup(
            jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jLabel16, javax.swing.GroupLayout.DEFAULT_SIZE, 496, Short.MAX_VALUE)
        );
        ...
        jLabel10.setText("ID TRAINER GYM");
        ...
        jPanel14Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel14Layout.createSequentialGroup()
                .addComponent(jLabel26, javax.swing.GroupLayout.DEFAULT_SIZE, 211, Short.MAX_VALUE)
                .addGap(18, 18, 18)
        ...
        jLabel28.setText("TANGGAL JOIN");

        dateJoin.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                dateJoinPropertyChange(evt);
            }
        });
        ...
        jPanel18Layout.setVerticalGroup(
            ...
            .addGroup(jPanel18Layout.createSequentialGroup()
                .addGroup(jPanel18Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(cAktif, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel18Layout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(jPanel18Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(dateJoin, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void b_simpanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_b_simpanMouseClicked
        ...
        String asql="insert into instruktur_gym values (?,?,?,?,?,?,?,?,?)";
        String jenis="", aktif="";
        
        if (r_laki.isSelected()){
        jenis="Laki-laki";}
        else if (r_perempuan.isSelected()){ jenis="Perempuan";}
        if (cAktif.isSelected()){aktif="aktif";}
        else {aktif="Nonaktif";}
        try{
                    ...
                    astat.setString(8,date1); 
                    astat.setString(9,aktif); 
                    astat.executeUpdate();
                    JOptionPane.showMessageDialog(null,"Data Trainer Berhasil Disimpan");
                    kosong();
                    txt_kode.requestFocus();
    ...
    private void b_editMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_b_editMouseClicked
        ...
        String asql="update instruktur_gym set nama_instruktur=?, usia=?, gender=?, alamat=?, no_telp=?, email=?, tanggal_join=?, aktif=? "
                + "where id_instruktur='"+b+"'";       
       // String atasan = c.replaceAll("\\s.*", "");
        try{
            PreparedStatement astat=conn.prepareStatement(asql); 
                    ...
                    astat.setString(7,date1); 
                    astat.setString(8,aktif); 
            astat.executeUpdate();
            
            JOptionPane.showMessageDialog(null,"Data Trainer Berhasil diubah");
            kosong();
    ...
    private void jPanel15MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel15MouseClicked
        ...
        if (ok==0){
            String sql="delete from instruktur_gym where id_instruktur='"+a+"'";
            try{
                PreparedStatement stat = conn.prepareStatement(sql);
                stat.executeUpdate();
                JOptionPane.showMessageDialog(null,"Data Instruktur Berhasil Dihapus");
                kosong();
                this.setVisible(false);
            }
            catch (SQLException e){
    ...
    private void dateJoinPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_dateJoinPropertyChange
        // TODO add your handling code here:
        if (dateJoin.getDate() !=null){
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
         date1 = sdf.format(dateJoin.getDate());
        }
    }//GEN-LAST:event_dateJoinPropertyChange
    ...
    private javax.swing.JCheckBox cAktif;
